...
export class CompleteJobWhenOrderedServiceIsCanceledAndKeptInvoiceDomainEventHandler {
  constructor(
  ...
  async handle(event: OrderedServiceCanceledAndKeptInvoiceDomainEvent) {
