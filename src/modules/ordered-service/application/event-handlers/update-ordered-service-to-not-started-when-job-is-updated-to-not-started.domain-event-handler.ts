...
export class UpdateOrderedServiceToNotStartedWhenJobIsUpdatedToNotStartedDomainEventHandler {
  ...
  @OnEvent([JobNotStartedDomainEvent.name, JobStartedDomainEvent.name], { promisify: true, async: true })
  async handle(event: JobNotStartedDomainEvent | JobStartedDomainEvent) {
