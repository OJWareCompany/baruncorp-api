...
import { Find${pascalDomainName}PaginatedHttpController } from './queries/find-${domainName}-paginated/${domainName}.paginated.http.controller'
...
import { Find${pascalDomainName}PaginatedQueryHandler } from './queries/find-${domainName}-paginated/${domainName}.paginated.query-handler'
